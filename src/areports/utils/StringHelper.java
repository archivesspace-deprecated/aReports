 ...
 * <p/>
 * 20Nov03 Fixed bug in replace method. length = stringLength + (count *
...
public class StringHelper {
    ...
    /**
     * Handles underscores by replacing them with spaces, and handles camelCase
     * by breaking words apart at the humps; it capitalizes the first word.
     */
    ...
    /**
     * A hash can be passed as a param using its toString() method; it comes in
     * looking like: {key1=val1, key2=val2, key3=val3} ; this method restores it
     * to a hash
     * <p/>
...
// where the last dot is. There may be more than one.
    ...
    /**
     * This method will remove the tags from a given string. If the string
     * contains no tags it will simply be returned. Example: <tag>string in
     * tag</tag> returns "string in tag" Example: <tag att="1">string in
     * tag</tag> returns "string in tag"
     */
    ...
    /**
     * Method to return a decimal which only has zeros following the decimal as
     * an integer value
     *
